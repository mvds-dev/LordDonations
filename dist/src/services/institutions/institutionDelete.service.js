...
const institutionDeleteService = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!(institution === null || institution === void 0 ? void 0 : institution.isActive)) {
        throw new appError_1.AppError(400, "Institution already deactivated");
    }
    yield institutionsRepository.update(institution.id, { isActive: false });
    return institution;
});
exports.default = institutionDeleteService;
