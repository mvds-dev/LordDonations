...
import { getObjectsByTypeController, listObjectsControler, listObjectsIsActiveControler } from "../controllers/objects.controllers";
...
const objectsRoutes = (app:Express) => {
    ...
    app.get("/objects/active/:typeId", getObjectsByTypeController);
