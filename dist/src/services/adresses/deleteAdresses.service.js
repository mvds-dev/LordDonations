...
const deleteAdressesService = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const updateUser = yield AddressesesRepository.delete(idExist);
});
exports.default = deleteAdressesService;
